...
#define REV_SORT_ARTIST		-offsetof(struct track_info, collkey_artist)
#define REV_SORT_ALBUM          -offsetof(struct track_info, collkey_album)
#define REV_SORT_TITLE          -offsetof(struct track_info, collkey_title)
#define REV_SORT_TRACKNUMBER    -offsetof(struct track_info, tracknumber)
#define REV_SORT_DISCNUMBER     -offsetof(struct track_info, discnumber)
#define REV_SORT_DATE           -offsetof(struct track_info, date)
#define REV_SORT_ORIGINALDATE   -offsetof(struct track_info, originaldate)
#define REV_SORT_RG_TRACK_GAIN  -offsetof(struct track_info, rg_track_gain)
#define REV_SORT_RG_TRACK_PEAK  -offsetof(struct track_info, rg_track_peak)
#define REV_SORT_RG_ALBUM_GAIN  -offsetof(struct track_info, rg_album_gain)
#define REV_SORT_RG_ALBUM_PEAK  -offsetof(struct track_info, rg_album_peak)
#define REV_SORT_GENRE          -offsetof(struct track_info, collkey_genre)
#define REV_SORT_COMMENT        -offsetof(struct track_info, collkey_comment)
#define REV_SORT_ALBUMARTIST    -offsetof(struct track_info, collkey_albumartist)
#define REV_SORT_FILENAME       -offsetof(struct track_info, filename)
#define REV_SORT_FILEMTIME      -offsetof(struct track_info, mtime)
#define REV_SORT_BITRATE        -offsetof(struct track_info, bitrate)
#define REV_SORT_CODEC          -offsetof(struct track_info, codec)
#define REV_SORT_CODEC_PROFILE  -offsetof(struct track_info, codec_profile)
#define REV_SORT_MEDIA          -offsetof(struct track_info, media)
